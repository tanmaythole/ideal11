...
def player_performance(param,player_name,opposition=None,venue=None):
    ...
    if param == 1:
        overall_batsman_details = pd.read_excel('dataset/player_details/overall_batsman_details.xlsx', header=0)
        ...
        overall_bowler_details = pd.read_excel('dataset/player_details/overall_bowler_details.xlsx',header=0)
